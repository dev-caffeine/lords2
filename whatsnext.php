...
<body>
<div class="container">
  <h1>Notes and Rules</h1>
  <div class="notes">
    <div class="note">
      <h2>Note 1</h2>
      <p>Your Application is under survey.Applicant will get reply in 1-2 working days</p>
    </div>
    <div class="note">
      <h2>Note 2</h2>
      <p>You can apply for loan after 15 days per application</p>
    </div>
    <!-- Repeat the structure for other notes -->
  </div>
  <div class="rules">
    <h2>Rules</h2>
    <ol>
      <li>If information in founded wrong application will be rejected.</li>
      <li>The Wrong application can effect on your credit score.</li>
      <li>Misleading the company can cause an legal action against the applicant.</li>
